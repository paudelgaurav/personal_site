        ...
        <p class="flex space-x-8 pt-4">
          <a :href="p.live_url" target="_blank"
            ...
            >
              ...
              ></path></svg
          ></a>
          <a href="p.code_url" target="_blank"
            ><img src="../assets/img/gt.svg" class="h-5 w-5"
          /></a>
        </p>
      </div>
    </div>
